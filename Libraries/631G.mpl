...
Nbas:=Array(1..Zmax): Nbas[1]:=2:
lmt:=-infinity..infinity:
Lbas:=Array(1..Zmax,1..2): Lbas[1,1]:=0: Lbas[1,2]:=0: 
Mbas:=Array(1..Zmax,1..2,1..3):
...
Bas:=Array(1..Zmax,1..2): BasN:=Array(1..Zmax,1..2):
Alp:=Vector(4):
Gs:=Vector(4):
...
#int(int(int(BasMol[1]^2,x=lmt),y=lmt),z=lmt); int(int(int(BasMol[2]^2,x=lmt),y=lmt),z=lmt);
#NBas:=NB(1);
